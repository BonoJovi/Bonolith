...
pub const CONNECTION_COST: [[f64; PartOfSpeech::COUNT]; PartOfSpeech::COUNT] = [
    ...
    [ 5.189, 5.351, 5.644, 6.424, 1.667, 3.469, 4.500, 6.342, 6.516, 2.500, 4.184  ],  // N ->   override: Suf, Conj
    [ 6.985, 4.429, 5.075, 6.374, 3.851, 1.789, 7.206, 5.751, 6.281, 6.497, 5.315  ],  // V ->
    [ 2.000, 5.672, 5.577, 6.618, 3.867, 3.837, 4.763, 5.437, 5.065, 4.827, 5.253  ],  // Adj ->   override: N
    [ 5.650, 2.500, 2.500, 4.727, 4.954, 5.229, 5.519, 4.895, 4.953, 5.647, 5.031  ],  // Adv ->   override: V, Adj
    [ 3.500, 3.000, 2.500, 3.500, 4.768, 6.287, 5.106, 6.452, 5.281, 7.354, 3.885  ],  // Part ->   override: N, V, Adj, Adv
    ...
    [ 3.000, 5.568, 6.079, 6.825, 1.267, 3.240, 7.476, 6.991, 8.000, 1.312, 3.952  ],  // Suf ->   override: N
